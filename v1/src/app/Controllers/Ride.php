...
$image_url = $this->env['app_url_live'] . "" . $dir . "" . $users['u_image'];
                ...
                $rides = Rides::select('cr_start_name as start', 'cr_stop_name as stop', 'cr_amount as amount', 'cr_payment_staus as payment_status', 'cr_booked_on as booked_on', 'cr_ride_end_time as booked_closed_on', 'cr_no_passengers as seats','u_first_name')
...
$image_url = $this->env['app_url_live'] . "" . $dir . "" . $users['u_image'];
        ...
        $rides = Rides::select('cr_id as ride_id', 'cr_start_name as start', 'cr_stop_name as stop', 'cr_amount as amount', 'cr_payment_staus as payment_status', 'cr_booked_on as booked_on', "cr_cab_ride_status as status", 'u_first_name')
 ->selectRaw("CONCAT('".$image_url."',`u_image`)  AS image")
...
return $user;
    ...
    public function rider_view_current_trip($request, $response, $args)
    {
        ...
        $rides = Rides::select('cr_id as ride_id', 'cr_user_id as u_id', 'cr_start_name as start', 'cr_stop_name as stop', 'cr_amount as amount', 'cr_payment_staus as payment_status', 'cr_booked_on as booked_on', "cr_cab_ride_status as status", 'u_first_name','cr_start_lat',
'cr_start_long' )
        ->selectRaw("CONCAT('".$image_url."',`u_image`)  AS image")
...
$response =  \GeometryLibrary\PolyUtil::distanceToLine(
              ...
              ['lat' =>$driver_locations, 'lng' => $driver_locations], // line startpoint array [lat, lng]
...
// $rides_with_distance[]=$response; // 12325.124046196 in meters
