...
// $this->logger->Notice('Crone Run', ['time' => time_now()]);
    ...
    // // $time="11:00:00";
    $longtime     = date('H:i:s', strtotime($time . '+1 hour'));
    // echo $longtime;
    $where        = array(
    ...
    if (!empty($details_data)) {
        ...
        $seats = $rides->cr_no_passengers;
         ...
         if ($drivers_distance = $this->getClosestCars($from_lat, $from_long, $groupby = "", $distance = $this->env['booking_distance'], $limit = 15)) { //find drivers near 15 km
